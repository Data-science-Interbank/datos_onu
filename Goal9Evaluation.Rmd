...
```{r}
cor.test(goal_9_regresion_all_years$Mean_population_covered_by_mobile_network,
         goal_9_regresion_all_years$Carbon_dioxide_emissions_from_fuel_combustion_millions_of_tonnes,method="kendall",exact=FALSE)
```
...
```
```{r}
cor.test(goal_9_regresion_2015$Mean_population_covered_by_mobile_network,
         goal_9_regresion_2015$Total_official_flows_for_infrastructure_millions_of_constant_2018_United_States_dollars,method="spearman",exact=FALSE)
```
...
## 2.5 ESTUDIO DE UN PAÍS EN CONCRETO
...
En el caso de Mozambique, podemos afirmar:
- Según crece el PIB menor es el flujo económico para infraestructuras ¿?
- Según crece el PIB mayor son las emisiones de C02
- Según crece el PIB más personas están cubiertas por red móvil
- Cuanto menor es el flujo económico para infraestructuras mayores son las emisiones de CO2
- Cuanto menor es el flujo económico para infraestructuras más personas están cubiertas por red móvil
- Cuanto mayores son las emisiones de C02 más personas están cubiertas por red móvil

PREGUNTAR POR LOS RESULTADOS GLOBALES Y SI TIENEN SENTIDO...
