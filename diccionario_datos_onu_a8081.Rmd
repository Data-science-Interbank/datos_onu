...
```{r read data_aux}
data_1 <- read_delim('./data/goal_1.csv', delim=";")
data_2 <- read_delim('./data/goal_2.csv', delim=",")
data_3 <- read_delim('./data/goal_3.csv', delim=";")
data_4 <- read_delim('./data/goal_4.csv', delim=";")
data_5 <- read_delim('./data/goal_5.csv', delim=";")
data_6 <- read_delim('./data/goal_6.csv', delim=";")
data_7 <- read_delim('./data/goal_7.csv', delim=";")
data_8 <- read_delim('./data/goal_8.csv', delim=";")
data_9 <- read_delim('./data/goal_9.csv', delim=";")
data_10 <- read_delim('./data/goal_10.csv', delim=",")
data_11 <- read_delim('./data/goal_11.csv', delim=",")
data_12 <- read_delim('./data/goal_12.csv', delim=",")
data_13 <- read_delim('./data/goal_13.csv', delim=",")
data_14 <- read_delim('./data/goal_14.csv', delim=",")
data_15 <- read_delim('./data/goal_15.csv', delim=",")
data_16 <- read_delim('./data/goal_16.csv', delim=";")
data_17 <- read_delim('./data/goal_17.csv', delim=",")
```
...
for (data in datasets){
  ...
  data_aux <- distinct(data, data$Measure, .keep_all = TRUE)
  number_measures <- nrow(data_aux)
  
  #Sobre ellas, obtenemos el 
  goal_number <- 0
  goal_name <- 0
  goal <- unique(data_aux$Goal.Name)
